        ...
        return (
          <Fragment key={id}>
            <div className="h-16 flex flex-col items-center justify-between shrink-0 px-4">
              <p className="font-normal text-[#AAAAAA] sm:text-[10px]">
                {label}
              </p>

              <div className="flex-1 flex flex-col items-center justify-center">
                <p className="font-medium text-[#AAAAAA] sm:text-[16px] uppercase">
                  {value}
                </p>
              ...
              {description && (
                <p className="font-normal text-[#AAAAAA] text-sm">
                  {description}
                </p>
              )}
            </div>
            ...
            {!isLast && (
              <div className="w-[1px] h-12 shrink-0 mx-3 bg-[#AAAAAA]" />
            )}
          </Fragment>
        );
      })}
