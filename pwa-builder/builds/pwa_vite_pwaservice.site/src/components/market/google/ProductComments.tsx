...
const ProductComments = ({ comments }: IProductCommentsProps) => {
  return (
        ...
        type === "user" ? (
          <div key={id} className="flex flex-col gap-2 mt-12">
            <div className="flex items-center gap-4">
              ...
              <h2 className="font-semibold text-[#202124] text-xl">
                {fullName}
              </h2>
            </div>
          ...
          <div
            key={id}
            className="w-full flex flex-col gap-2 p-6 bg-[#F8F9FA] mt-4"
          >
            <div className="flex items-center justify-between">
              <h2 className="font-semibold text-[#202124] text-xl">
                {fullName}
