...
const AppleProductSection = ({ image, name, creator }: IAppleProductSectionProps) => {
  return (
    <div className="flex mb-[20px] mt-[20px]">
      ...
      <div className="ml-[12px]">
        ...
        <h3 className="font-medium sm:text-[14px] text-[#797979] uppercase mb-[9px]">{creator}</h3>

        <InstallButton text="Instalar" variant="apple" onClick={() => console.log("test")} />
      </div>
    </div>
  );
};
