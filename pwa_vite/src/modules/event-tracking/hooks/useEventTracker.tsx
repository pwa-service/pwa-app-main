...
import { parseURLParams, saveData } from "../helpers";
import { postViewContent, postFirstOpen } from "../api";

export interface EventTrackerState {
  trackerData: EventData | null;
...
const useEventTracker = () => {
  ...
  const handleViewContent = async (data: EventData) => {
